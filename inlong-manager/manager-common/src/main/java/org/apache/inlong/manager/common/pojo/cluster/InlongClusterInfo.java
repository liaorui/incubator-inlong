...
@JsonSubTypes({
        @JsonSubTypes.Type(value = DataProxyClusterInfo.class, name = ClusterType.CLS_DATA_PROXY),
        @JsonSubTypes.Type(value = PulsarClusterInfo.class, name = ClusterType.CLS_PULSAR),
        @JsonSubTypes.Type(value = TubeClusterInfo.class, name = ClusterType.CLS_TUBE),
})
