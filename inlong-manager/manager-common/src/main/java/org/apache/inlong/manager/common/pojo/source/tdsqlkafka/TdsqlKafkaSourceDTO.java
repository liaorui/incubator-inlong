...
/**
 * tdsql-kafka source information data transfer object.
 */
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class TdsqlKafkaSourceDTO {
     ...
     */
    public static TdsqlKafkaSourceDTO getFromRequest(TdsqlKafkaSourceRequest request) {
        return TdsqlKafkaSourceDTO.builder()
    ...
    public static TdsqlKafkaSourceDTO getFromJson(@NotNull String extParams) {
        try {
            OBJECT_MAPPER.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
            return OBJECT_MAPPER.readValue(extParams, TdsqlKafkaSourceDTO.class);
        } catch (Exception e) {
