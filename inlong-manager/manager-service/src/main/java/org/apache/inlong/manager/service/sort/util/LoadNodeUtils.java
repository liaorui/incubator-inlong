...
public class LoadNodeUtils {
    ...
    public static LoadNode createLoadNode(StreamSink streamSink, Map<String, StreamField> constantFieldMap) {
        ...
        switch (sinkType) {
            ...
            case POSTGRES:
                return createLoadNode((PostgresSink) streamSink, fieldInfos, fieldRelations, properties);
            case CLICKHOUSE:
     ...
     */
    public static PostgresLoadNode createLoadNode(PostgresSink postgreSQLSink, List<FieldInfo> fieldInfos,
            List<FieldRelation> fieldRelations, Map<String, String> properties) {
