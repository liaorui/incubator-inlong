 ...
 */
@Service
public class TdsqlKafkaSourceOperation extends AbstractSourceOperation {
    ...
    public Boolean accept(SourceType sourceType) {
        return SourceType.TDSQL_KAFKA == sourceType;
    }

    @Override
    protected String getSourceType() {
        return SourceType.TDSQL_KAFKA.getType();
    }

    @Override
    protected StreamSource getSource() {
        return new TdsqlKafkaSource();
    }
