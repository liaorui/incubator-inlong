 ...
 */
public enum TdsqlKafkaScanStartupMode {
    ...
    TdsqlKafkaScanStartupMode(String value) {
        this.value = value;
    }
    ...
    public static TdsqlKafkaScanStartupMode forName(String name) {
        for (TdsqlKafkaScanStartupMode startupMode : values()) {
