...
/**
 * TDSQL-Kafka load node using tdsql-kafka connectors provided by Oceanus
 */
@EqualsAndHashCode(callSuper = true)
@JsonTypeName("tdsqlKafkaLoad")
@Data
@NoArgsConstructor
public class TdsqlKafkaLoadNode extends LoadNode implements Metadata, Serializable {
    ...
    @JsonCreator
    public TdsqlKafkaLoadNode(@JsonProperty("id") String id,
