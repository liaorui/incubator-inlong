...
/**
 * Test for {@link TidbExtractNodeTest}
 */
public class TidbExtractNodeTest extends SerializeBaseTest<TidbExtractNode> {

    @Override
    public TidbExtractNode getTestObject() {
    ...
    public void testMetaFields() {
        ...
        TidbExtractNode node = getTestObject();
