...
public class ReadPhaseMetricData implements MetricData {
    ...
    /**
     * Register read phase time metrics and user can use custom counter that extends from {@link Counter}, and note
     * that
     * we just keep the time to change that moment
     * groupId and streamId and nodeId and readPhase are label value, user can use it filter metric data when use metric
     * reporter
     * prometheus
     */
