...
package org.apache.inlong.sort.cdc.mongodb.source.meta.split;
...
/**
 * A kind of {@link com.ververica.cdc.connectors.base.source.meta.split.SnapshotSplit} without table schema
 * information, it is useful to reduce memory usage in JobManager.
 */
