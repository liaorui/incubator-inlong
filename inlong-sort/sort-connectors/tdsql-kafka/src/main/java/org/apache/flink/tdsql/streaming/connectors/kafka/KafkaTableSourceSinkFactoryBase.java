...
package org.apache.flink.tdsql.streaming.connectors.kafka;
...
import org.apache.flink.tdsql.streaming.connectors.kafka.partitioner.FlinkFixedPartitioner;
import org.apache.flink.tdsql.streaming.connectors.kafka.partitioner.FlinkKafkaPartitioner;
import org.apache.flink.tdsql.streaming.connectors.kafka.table.TDSQLKafkaDynamicTableFactory;
import org.apache.flink.table.api.TableException;
import org.apache.flink.table.api.TableSchema;
import org.apache.flink.table.descriptors.DescriptorProperties;
import org.apache.flink.tdsql.table.descriptors.KafkaValidator;
...
import static org.apache.flink.tdsql.table.descriptors.KafkaValidator.CONNECTOR_PROPERTIES;
import static org.apache.flink.tdsql.table.descriptors.KafkaValidator.CONNECTOR_PROPERTIES_KEY;
import static org.apache.flink.tdsql.table.descriptors.KafkaValidator.CONNECTOR_PROPERTIES_VALUE;
import static org.apache.flink.tdsql.table.descriptors.KafkaValidator.CONNECTOR_SINK_PARTITIONER;
import static org.apache.flink.tdsql.table.descriptors.KafkaValidator.CONNECTOR_SINK_PARTITIONER_CLASS;
import static org.apache.flink.tdsql.table.descriptors.KafkaValidator.CONNECTOR_SINK_PARTITIONER_VALUE_CUSTOM;
import static org.apache.flink.tdsql.table.descriptors.KafkaValidator.CONNECTOR_SINK_PARTITIONER_VALUE_FIXED;
import static org.apache.flink.tdsql.table.descriptors.KafkaValidator.CONNECTOR_SINK_PARTITIONER_VALUE_ROUND_ROBIN;
import static org.apache.flink.tdsql.table.descriptors.KafkaValidator.CONNECTOR_SPECIFIC_OFFSETS;
import static org.apache.flink.tdsql.table.descriptors.KafkaValidator.CONNECTOR_SPECIFIC_OFFSETS_OFFSET;
import static org.apache.flink.tdsql.table.descriptors.KafkaValidator.CONNECTOR_SPECIFIC_OFFSETS_PARTITION;
import static org.apache.flink.tdsql.table.descriptors.KafkaValidator.CONNECTOR_STARTUP_MODE;
import static org.apache.flink.tdsql.table.descriptors.KafkaValidator.CONNECTOR_STARTUP_TIMESTAMP_MILLIS;
import static org.apache.flink.tdsql.table.descriptors.KafkaValidator.CONNECTOR_TOPIC;
import static org.apache.flink.tdsql.table.descriptors.KafkaValidator.CONNECTOR_TYPE_VALUE_KAFKA;
 ...
 *
 * @deprecated Use {@link TDSQLKafkaDynamicTableFactory}.
 */
@Deprecated
