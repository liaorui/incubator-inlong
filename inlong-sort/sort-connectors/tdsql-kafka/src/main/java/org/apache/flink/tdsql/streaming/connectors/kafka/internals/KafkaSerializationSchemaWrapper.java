...
import org.apache.flink.tdsql.streaming.connectors.kafka.KafkaContextAware;
import org.apache.flink.tdsql.streaming.connectors.kafka.KafkaSerializationSchema;
 ...
 * FlinkKafkaPartitioner} to the {@link
