...
public class KafkaConsumerMetricConstants {
    ...
    public static final String SOURCE_NUM_BYTES_IN = "sourceNumBytesIn";
    public static final String SOURCE_NUM_BYTES_IN_RATE = SOURCE_NUM_BYTES_IN + SUFFIX_RATE;
    public static final String SOURCE_NUM_RECORDS_IN = "sourceNumRecordsIn";
    public static final String SOURCE_NUM_RECORDS_IN_RATE = SOURCE_NUM_RECORDS_IN + SUFFIX_RATE;

    public static final String SINK_NUM_BYTES_OUT = "sinkNumBytesOut";
    public static final String SINK_NUM_BYTES_OUT_RATE = SINK_NUM_BYTES_OUT + SUFFIX_RATE;
    public static final String SINK_NUM_RECORDS_OUT = "sinkNumRecordsOut";
    public static final String SINK_NUM_RECORDS_OUT_RATE = SINK_NUM_RECORDS_OUT + SUFFIX_RATE;
}
