...
import org.apache.flink.tdsql.streaming.connectors.kafka.FlinkKafkaException;
...
public class FlinkKafkaShuffleProducer<IN, KEY> extends FlinkKafkaProducer<IN> {
    ...
    FlinkKafkaShuffleProducer(
        ...
        Preconditions.checkArgument(
                props.getProperty(FlinkKafkaShuffle.PARTITION_NUMBER) != null,
                "Missing partition number for Kafka Shuffle");
        numberOfPartitions = PropertiesUtil.getInt(props, FlinkKafkaShuffle.PARTITION_NUMBER, Integer.MIN_VALUE);
    }
