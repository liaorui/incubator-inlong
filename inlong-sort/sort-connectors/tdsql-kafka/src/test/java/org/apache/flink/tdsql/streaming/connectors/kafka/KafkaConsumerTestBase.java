...
import org.apache.flink.tdsql.connector.kafka.source.KafkaSource;
import org.apache.flink.tdsql.connector.kafka.source.KafkaSourceBuilder;
...
import org.apache.flink.tdsql.streaming.connectors.kafka.internals.KafkaDeserializationSchemaWrapper;
import org.apache.flink.tdsql.streaming.connectors.kafka.internals.KafkaTopicPartition;
import org.apache.flink.tdsql.streaming.connectors.kafka.testutils.*;
import org.apache.flink.tdsql.streaming.connectors.kafka.testutils.*;
import org.apache.flink.tdsql.streaming.util.serialization.KeyedSerializationSchema;
import org.apache.flink.tdsql.streaming.util.serialization.TypeInformationKeyValueSerializationSchema;
...
public abstract class KafkaConsumerTestBase extends KafkaTestBaseWithFlink {
    ...
    public void runStartFromLatestOffsets() throws Exception {
        ...
        ClusterCommunicationUtils.waitUntilJobIsRunning(client);
