...
package org.apache.flink.tdsql.streaming.connectors.kafka.shuffle;
...
import org.apache.flink.tdsql.streaming.connectors.kafka.internals.KafkaShuffleFetcher.KafkaShuffleElement;
import org.apache.flink.tdsql.streaming.connectors.kafka.internals.KafkaShuffleFetcher.KafkaShuffleElementDeserializer;
import org.apache.flink.tdsql.streaming.connectors.kafka.internals.KafkaShuffleFetcher.KafkaShuffleRecord;
import org.apache.flink.tdsql.streaming.connectors.kafka.internals.KafkaShuffleFetcher.KafkaShuffleWatermark;
...
import static org.apache.flink.tdsql.streaming.connectors.kafka.shuffle.FlinkKafkaShuffle.PARTITION_NUMBER;
import static org.apache.flink.tdsql.streaming.connectors.kafka.shuffle.FlinkKafkaShuffle.PRODUCER_PARALLELISM;
