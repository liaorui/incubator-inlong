...
import static org.apache.flink.tdsql.streaming.connectors.kafka.FlinkKafkaProducer.DEFAULT_KAFKA_PRODUCERS_POOL_SIZE;
import static org.apache.flink.tdsql.streaming.connectors.kafka.FlinkKafkaProducer.Semantic.EXACTLY_ONCE;
import static org.apache.flink.tdsql.streaming.connectors.kafka.table.KafkaTableTestUtils.readLines;
import static org.apache.flink.tdsql.streaming.connectors.kafka.table.KafkaTableTestUtils.waitingExpectedResults;
