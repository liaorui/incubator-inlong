...
public class KafkaTableITCase extends KafkaTableTestBase {
            ...
            createTable =
                    String.format(
                            "create table kafka (\n"
                                    ...
                                    + "  %s\n"
                                    + ")",
                            TDSQLKafkaDynamicTableFactory.IDENTIFIER,
                            topic,
                            bootstraps,
                            groupId,
                            formatOptions());
    ...
    public void testKafkaSourceSinkWithMetadata() throws Exception {
        ...
        final List<Row> result = KafkaTableTestUtils.collectRows(tEnv.sqlQuery("SELECT * FROM kafka"), 3);
    ...
    private void initialProductChangelog(String topic, String bootstraps) throws Exception {
        ...
        String[] allChangelog = KafkaTableTestUtils.readLines("product_changelog.txt").toArray(new String[0]);
