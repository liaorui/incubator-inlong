...
import org.apache.flink.tdsql.streaming.connectors.kafka.FlinkKafkaConsumer;
import org.apache.flink.tdsql.streaming.connectors.kafka.FlinkKafkaProducer;
...
import static org.apache.flink.tdsql.streaming.connectors.kafka.table.KafkaOptions.AVRO_CONFLUENT;
import static org.apache.flink.tdsql.streaming.connectors.kafka.table.KafkaOptions.DEBEZIUM_AVRO_CONFLUENT;
import static org.apache.flink.table.factories.utils.FactoryMocks.createTableSink;
import static org.apache.flink.table.factories.utils.FactoryMocks.createTableSource;
import static org.hamcrest.CoreMatchers.instanceOf;
import static org.junit.Assert.*;

/** Abstract test base for {@link TDSQLKafkaDynamicTableFactory}. */
public class TDSQLKafkaDynamicTableFactoryTest extends TestLogger {
    ...
    private void verifyEncoderSubject(
        ...
        options.put("connector", TDSQLKafkaDynamicTableFactory.IDENTIFIER);
    ...
    private static Map<String, String> getBasicSourceOptions() {
        ...
        // Kafka specific options.
        tableOptions.put("connector", TDSQLKafkaDynamicTableFactory.IDENTIFIER);
