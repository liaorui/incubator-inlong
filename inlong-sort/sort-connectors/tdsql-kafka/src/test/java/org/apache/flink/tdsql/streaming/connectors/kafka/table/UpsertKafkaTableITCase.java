...
public class UpsertKafkaTableITCase extends KafkaTableTestBase {
    ...
    public void testSourceSinkWithKeyAndPartialValue() throws Exception {
        ...
        final List<Row> result = KafkaTableTestUtils.collectRows(tEnv.sqlQuery("SELECT * FROM upsert_kafka"), 5);
    ...
    private void wordCountToUpsertKafka(String wordCountTable) throws Exception {
        ...
        final List<Row> result = KafkaTableTestUtils.collectRows(tEnv.sqlQuery("SELECT * FROM " + wordCountTable), 11);
        ...
        KafkaTableTestUtils.comparedWithKeyAndOrder(expected, result, new int[] {0});
        ...
        final List<Row> result2 =
                KafkaTableTestUtils.collectRows(tEnv.sqlQuery("SELECT * FROM " + rawWordCountTable), 8);
        ...
        KafkaTableTestUtils.comparedWithKeyAndOrder(expected2, result2, new int[] {0});
    }
    ...
    private void wordFreqToUpsertKafka(String wordCountTable) throws Exception {
        ...
        KafkaTableTestUtils.waitingExpectedResults("sink_" + format, expectedData, Duration.ofSeconds(10));
    ...
    private void writeChangelogToUpsertKafkaWithMetadata(String userTable) throws Exception {
        ...
        final List<Row> result = KafkaTableTestUtils.collectRows(tEnv.sqlQuery("SELECT * FROM " + userTable), 16);
    ...
    private void temporalJoinUpsertKafka(String userTable) throws Exception {
        ...
        final List<Row> result =
                KafkaTableTestUtils.collectRows(
                        tEnv.sqlQuery(
                                String.format(
