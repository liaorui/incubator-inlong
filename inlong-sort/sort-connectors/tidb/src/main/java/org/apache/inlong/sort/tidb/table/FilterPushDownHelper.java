...
package org.apache.inlong.sort.tidb.table;
...
public class FilterPushDownHelper {
  ...
  private static final Set<FlinkExpression> COMPARISON_BINARY_FILTERS = ImmutableSet.of(
      FlinkExpression.greaterThan,
      FlinkExpression.greaterThanOrEqual,
      FlinkExpression.lessThan,
      FlinkExpression.lessThanOrEqual,
      FlinkExpression.equals,
      FlinkExpression.notEquals,
      FlinkExpression.like
  );
