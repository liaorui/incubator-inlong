 ...
 */
public class TidbExtractFlinkSqlParseTest extends AbstractTestBase {

    /**
     * build tidb extract node
     *
     * @return
     */
    private TidbExtractNode buildTidbNode() {
    ...
    /**
     * Test flink sql task for extract is postgres {@link TidbExtractNode} and load is hbase {@link HbaseLoadNode}
     *
